...
(with-eval-after-load 'dired
  ...
  (dired-rainbow-define compressed "#51d88a"
                        ("7z" "zip" "bz2" "tgz" "txz" "gz" "xz"
                         "z" "Z" "zst" "jar" "war" "ear" "rar"
                         "sar" "xpi" "apk" "xz" "tar"))
